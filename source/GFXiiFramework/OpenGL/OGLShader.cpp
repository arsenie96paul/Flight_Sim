...
EShaderError OGLShader::CreateShaderFromSourceFile(LPCWSTR filename, EShaderType type)
{
	...
	switch(type)
	{
		...
		case SKYBOX_SHADER_VERTEX: shadertype = GL_VERTEX_SHADER; break;
		case SKYBOX_SHADER_FRAGMEMT: shadertype = GL_FRAGMENT_SHADER; break;
	...
	{
		fprintf(stdout, "Shader %ws has been successfully compiled.\n", filename);
	}
